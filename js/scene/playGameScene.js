...
class PlayGameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('gun-shot', 'assets/images/sounds/gunshot.wav')
        this.load.audio('coinhit', 'assets/images/sounds/coin.wav')
        this.load.audio('endgame', 'assets/images/sounds/coin.wav')
